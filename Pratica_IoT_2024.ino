...
#define MQTT_MILLIS_TOPIC "182270416_IoT-SEMB2_Tanque"
#define MQTT_LED_TOPIC "182270416_IoT-SEMB2_Tanque"
...
// ------------- _________________________ ---------------------
  ...
  if (now - lastMsg > 3000) 
  { //Envio periódico de msg MQTT
    lastMsg = now;
    value2 = temperatureC;
    snprintf (msg, MSG_BUFFER_SIZE, "Teperatura %lfºC", value2);
    Serial.println(msg);
    value1 = distanceCm;
    snprintf (msg, MSG_BUFFER_SIZE, "Distancia %lfºC", value1);
    Serial.println(msg);
    MQTT.publish("182270416_IoT-SEMB2_Tanque", msg);
  }
